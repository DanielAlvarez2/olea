                                                    ...
                                                    {allDinnerMenuItems.filter(item=>item.sequence && item.section == 'cured meats').map(data=>{
                                                        return(
                                                            <div    key={data._id}
                                                                ...
                                                                <span className='price'> &nbsp;{data.price.includes('/') ? <div style={{display:'inline-block',width:'100%'}}>{data.price.split('/')[0].trim()}<br/>{data.price.split('/')[1].trim()}</div> : data.price}</span> 
